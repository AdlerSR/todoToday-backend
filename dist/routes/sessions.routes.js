...
var sessionRouter = express_1["default"]();
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                sessionService = new CreateSessionService_1["default"]();
                return [4 /*yield*/, sessionService.execute({ email: email, password: password })];
            case 1:
