...
var UpdateUserAvatar = /** @class */ (function () {
    ...
    UpdateUserAvatar.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var avatarRepository, user, userAvatarFilePath, userAvatarFileExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        avatarRepository = typeorm_1.getRepository(Users_1["default"]);
                        return [4 /*yield*/, avatarRepository.findOne(user_id)];
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1["default"]('Only authenticated users can chance avatar.', 400);
                        }
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, avatarRepository.save(user)];
                    case 5:
                        _b.sent();
